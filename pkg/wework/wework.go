...
type IWeWork interface {
	...
	UserCreate(corpId uint, user User) (resp BizResponse)
	UserUpdate(corpId uint, user User) (resp BizResponse)
	UserDelete(corpId uint, userId string) (resp BizResponse)
	...
	CorpTagUpdate(corpId uint, tag CorpTag) (resp BizResponse)
	CorpTagDelete(corpId uint, tagIds, groupIds []string) (resp BizResponse)
	MarkTag(corpId uint, userId string, externalUserId string, addTag []int, removeTag []int) (resp BizResponse)

	DepartmentCreate(corpId uint, department Department) (resp DepartmentCreateResponse)
	DepartmentUpdate(corpId uint, department Department) (resp BizResponse)
	DepartmentDelete(corpId uint, id int32) (resp BizResponse)
	...
	ExternalContactRemark(corpId uint, remark ExternalContactRemarkRequest) (resp BizResponse)
	...
	ExternalUpdateContactWay(corpId uint, me ContactMe) (resp BizResponse)
	...
	ExternalDeleteContactWay(corpId uint, configId string) (resp BizResponse)
	ExternalCloseTempChat(corpId uint, userId, externalUserId string) (resp BizResponse)
	...
	SendWelcomeMsg(corpId uint, msg ExternalMsg) (resp BizResponse)
	...
	UpdateProductAlbum(corpId uint, request ProductUpdateRequest) (resp BizResponse)
	DeleteProductAlbum(corpId uint, productId string) (resp BizResponse)
	...
	UpdateInterceptRule(corpId uint, request UpdateInterceptRuleRequest) (resp BizResponse)
	DeleteInterceptRule(corpId uint, ruleId string) (resp BizResponse)
	...
	BotMessageSend(key string, msg interface{}) (resp MessageSendResponse)
	MessageReCall(corpId uint, msgId string) (resp BizResponse)
	...
	TagUpdate(corpId uint, tag Tag) (resp BizResponse)
	TagDelete(corpId uint, id int) (resp BizResponse)
	...
	UpdateInvoiceStatus(corpId uint, request UpdateInvoiceStatusRequest) (resp BizResponse)
	UpdateInvoiceStatusBatch(corpId uint, request UpdateInvoiceStatusBatchRequest) (resp BizResponse)

	CreateStudent(corpId uint, student Student) (resp BizResponse)
	BatchCreateStudent(corpId uint, students []Student) (resp BatchStudentResponse)
	DeleteStudent(corpId uint, userId string) (resp BizResponse)
	BatchDeleteStudent(corpId uint, userIdList []string) (resp BatchStudentResponse)
	UpdateStudent(corpId uint, student Student) (resp BizResponse)
	BatchUpdateStudent(corpId uint, students []Student) (resp BatchStudentResponse)

	CreateParent(corpId uint, parent Parent) (resp BizResponse)
	BatchCreateParent(corpId uint, parents []Parent) (resp BatchParentResponse)
	DeleteParent(corpId uint, userId string) (resp BizResponse)
	BatchDeleteParent(corpId uint, userIdList []string) (resp BatchParentResponse)
	UpdateParent(corpId uint, parent Parent) (resp BizResponse)
	...
	SetArchSyncMode(corpId uint, mode int) (resp BizResponse)
	GetSubScribeQrCode(corpId uint) (resp GetSubScribeQrCodeResponse)
	SetSubScribeMode(corpId uint, mode int) (resp BizResponse)
	...
	SetTeacherViewMode(corpId uint, mode int) (resp BizResponse)
	...
	SchoolDepartmentUpdate(corpId uint, department SchoolDepartment) (resp BizResponse)
	SchoolDepartmentDelete(corpId uint, departmentId int32) (resp BizResponse)
	...
	DeleteReplayData(corpId uint, livingId string) (resp BizResponse)
	...
	KfAccountDel(corpId uint, kfId string) (resp BizResponse)
	KfAccountUpdate(corpId uint, account KfAccount) (resp BizResponse)
	...
	KfUpgradeService(corpId uint, request UpgradeServiceRequest) (resp BizResponse)
	KfCancelUpgradeService(corpId uint, request CancelUpgradeServiceRequest) (resp BizResponse)
	// KfGetCorpStatistic
	...
	KfKnowLedgeDelGroup(corpId uint, groupId string) (resp BizResponse)
	KfKnowLedgeModGroup(corpId uint, name string, groupId string) (resp BizResponse)
	...
	ActiveAccount(request ActiveAccountRequest) (resp BizResponse)
	...
	SetAutoActiveStatus(request SetAutoActiveStatusRequest) (resp BizResponse)
	...
	RemindGroupMsgSend(corpId uint, msgid string) (resp BizResponse)
	CancelMomentTask(corpId uint, momentId string) (resp BizResponse)

	SetProxy(proxyUrl string)
	SetDebug(debug bool)
	SetCache(opts RedisOpts)
}
...
func (ww *weWork) SetCache(opts RedisOpts) {
	ww.cache = NewRedis(context.Background(), &opts)
}
