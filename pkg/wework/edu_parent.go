...
func (ww *weWork) CreateParent(corpId uint, parent Parent) (resp BizResponse) {
...
func (ww *weWork) DeleteParent(corpId uint, userId string) (resp BizResponse) {
...
func (ww *weWork) UpdateParent(corpId uint, parent Parent) (resp BizResponse) {
