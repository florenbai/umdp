...
func (ww *weWork) SchoolDepartmentUpdate(corpId uint, department SchoolDepartment) (resp BizResponse) {
	if department.Id < 0 {
		resp.ErrCode = 500
...
func (ww *weWork) SchoolDepartmentDelete(corpId uint, departmentId int32) (resp BizResponse) {
