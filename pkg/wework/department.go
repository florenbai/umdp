...
func (ww *weWork) DepartmentUpdate(corpId uint, department Department) (resp BizResponse) {
	if department.Id < 1 {
		resp.ErrCode = 500
...
func (ww *weWork) DepartmentDelete(corpId uint, id int32) (resp BizResponse) {
