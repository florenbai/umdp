...
func (ww *weWork) KfKnowLedgeDelGroup(corpId uint, groupId string) (resp BizResponse) {
...
func (ww *weWork) KfKnowLedgeModGroup(corpId uint, name string, groupId string) (resp BizResponse) {
